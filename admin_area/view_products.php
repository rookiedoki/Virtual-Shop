<html>
 ...
 <link rel="stylesheet" type="text/css" href="styles/global.css" />
	...
	<div id="container">
		...
		.tg td{font-family:Arial, sans-serif;font-size:17px;padding:0px 15px;border-style:solid;border-width:1px;border-color:#aabcfe;color:#669;background-color:#e8edff;}
		.tg th{font-family:Arial, sans-serif;font-size:17px;font-weight:normal;padding:5px;border-style:solid;border-color:#aabcfe;color:#039;background-color:#b9c9fe;}
		.tg .tg-0ord{text-align:right}
		.tg .tg-ifyx{background-color:#D2E4FC;text-align:right}
		.tg .tg-s6z2{text-align:center; padding:1px;}
