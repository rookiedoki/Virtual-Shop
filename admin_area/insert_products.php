...
<?php
	if(isset($_POST['insert_products']))
	{
		...
		$temp_name1 = $_FILES['product_img1']['tmp_name'];
				...
				if($product_title =='' OR $product_cat=='' OR $product_desc =='' OR $product_keywords=='' OR $product_img1=='' OR $product_price==''){
				...
				else
				{
					...
					$insert_products = "insert into products (cat_id,date,product_title,product_img1,product_price,product_desc,status)values('$product_cat',NOW(),'$product_title','$product_img1','$product_price','$product_desc','$status')";
