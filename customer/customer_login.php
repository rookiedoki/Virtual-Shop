...
?>
	...
	<form action="checkout.php" method="post">
		<table width="600" align="center">
			...
			<tr>
				<td align="center" colspan="5"><br/><a href="checkout.php?forgot_pass">Forgot Password</a></td>
			</tr>
			<tr>
				<td align="center" colspan="5"><input type="submit" name="customer_login" value="Login"/></td>
			</tr>
	 	...
	 	if(isset($_GET['forgot_pass']))
	 	{
	 		...
	 		if(isset($_POST['forgot_pass']))
	 		{
	 			...
	 			else
	 			{
	 				//composing message 
	 				echo "OK";
	 				$from='admin@vshop.com';
	 				$subject='Password Recovery';
	 				$headers = "From: admin@vshop.com";
